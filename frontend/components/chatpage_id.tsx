  ...
  const setupWebSocket = () => {
    ...
    ws.current.onmessage = (event) => {
      ...
      if (data.event === 'on_parser_start') {
        ...
        setResponses(prevResponses => [...prevResponses, { sender: 'bot', message: '', id: data.run_id }]);
        setnewResponses(prevResponses => [...prevResponses, { sender: 'bot', message: '', id: data.run_id }]);
        ...
        setnewResponses(prevResponses => prevResponses.map(msg =>
          msg.id === data.run_id ? { ...msg, message: msg.message + data.data.chunk } : msg));
      }
    };
