...
class MilvusVectorClient(VectorClient):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.vector_db = self.connect(
            self.collection_name, self.hostname, self.port, embedding_size=self.embedding_size
        )
    ...
    def update(self, documents, embeddings, collection_name):
        ...
        for i, doc in enumerate(documents):
            ...
            example = {"id": doc_id, "content": doc.page_content, "embedding": embeddings[i], "metadata": doc.metadata}
    ...
    def get_schema(self, embedding_size):
        ...
        fields = [
            ...
            FieldSchema(
                name="content", dtype=DataType.VARCHAR, max_length=10000
            ),  # Text field with up to 10000 characters
